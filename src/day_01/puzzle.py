...
################################################################################
    ...
    def __init__(self):
        ...
        with open(self.INPUT_FILE_PATH, "r") as f:
            self._instructions = f.read().split(", ")
            self._direction = 0
            self._pos_x = 0
            self._pos_y = 0
            self._paths = []
...
################################################################################
    ...
    def follow_instructions(self) -> None:
        ...
        for instruction in self._instructions:
            ...
            self._pos_x, self._pos_y = self.MOVEMENT[self._direction](
                self._pos_x, self._pos_y, blocks)
...
################################################################################
    ...
    def _intersection(
        ...
        if min(vertical_from_y, vertical_to_y) \
                < horizontal_y \
                < max(vertical_from_y, vertical_to_y) \
                and min(horizontal_from_x, horizontal_to_x) \
                < vertical_x \
...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 242.
    """

    santa = Santa()
    santa.follow_instructions()
    print_puzzle_solution(santa.fake_hq_distance)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 150.
    """

    santa = Santa()
    santa.follow_instructions()
    print_puzzle_solution(santa.real_hq_distance)
