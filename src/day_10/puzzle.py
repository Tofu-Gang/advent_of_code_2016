...
def puzzle_01() -> int:
    ...
    :return: number of the bot that is responsible for comparing value-61
    microchip with value-17 microchips
    """

    factory = Factory()
    factory.run_instructions()
    return factory.goal_bot
...
def puzzle_02() -> int:
    ...
    :return: multiplication of outputs 0, 1 and 2 values
    """

    factory = Factory()
    factory.run_instructions()
    return factory.goal_product
